...
# Function takes in the opponents move and my move (which is either 0,1,2) and returns the outcome score (for me)
...
# Given the opponents move and the desired outcome, this function returns the correct move that I should play
...
with open('puzzle_input.txt') as puzzle_input:
    ...
    print("My total score would be {} (part 1)".format(my_total_score_part1))
...
with open('puzzle_input.txt') as puzzle_input:
    ...
    print("My total score would be {} (part 2)".format(my_total_score_part2))